...
Max(date(INSPECTIONENTRYDT)) as LAST_INSPECTION_DT,
...
FROM ((((( (((((( ((((  ((( (
	...
	Permit P JOIN PermitType PT on PT.id = P.permitTypeId and  programcategoryid ='2W1WFMYG0006KD84EKJ3RBNABT' and P.num = 'WQ0000520'
	...
	JOIN OWNER O on O.iD = FCTY.OWNERID)
        ...
        LEFT OUTER JOIN   INSPECTION   I ON I.PERMITID  = P.id)
        LEFT OUTER JOIN INSPECTIONAFFILIATION IA on IA.inspectionid = I.id)        
